...
public:
    ...
    Q_INVOKABLE void wallpaperLoadFailed(const QString& workshopId, const QString& reason);
    Q_INVOKABLE void playlistAdvanced(const QString& workshopId, const QString& title,
